...
use crate::model::{
    ArmorSlot, EnemySpawn, EnemyType, ItemDef, NpcKind, PickupType, PropKind, TileGrid, TileType,
    WorldProp,
};
...
/// Lore text shown when a Lore pickup is collected, keyed by location.
/// Overworld entries trace Mira's life across the biomes; dungeon entries
/// carry the Dragonbinder's journal and the dragon's own words.
pub fn lore_text(in_dungeon: bool, dungeon_id: i32, x: i32, y: i32) -> &'static str {
    if !in_dungeon {
        return match (x, y) {
            (4, 10) => "A chalk drawing on a flat stone:\na dragon, by a small hand.\n\"Mira, age 5.\"",
            (12, 6) => "A crude cave mural: a dragon\nflying over the sea, whole and\nunbroken. \"Mira, age 6.\"",
            (6, 5) => "A note beside the silver pool:\n\"The pool shows the place that\nmatters most to you. I saw a\nthrone room. I'm going there. -- M.\"",
            (4, 1) => "Names cover the Threshold Stone.\nMira, age 14. Age 17. Age 21.\nAge 26. Beside the last one,\na tiny dragon. Always the same.",
            (9, 2) => "A builder's note: \"We built a\ntower to point at a hole in the\nsky. It was the most honest\nthing we could do.\"",
            (1, 6) => "An engineer's final report:\n\"Recommend evacuation. Insist,\nactually. This will be filed\nand ignored. I am going home.\"",
            (6, 11) => "A burned page: \"The warden\nwould not let us leave. He said\nthe city was still safe.\nThe city was not safe.\"",
            (8, 7) => "A forge worker's cache note:\n\"Sealed with forge-grade mortar.\nIt will hold two centuries.\"\nIt held.",
            _ => "Someone left a message here,\nworn beyond reading.",
        };
    }
    match (dungeon_id, x, y) {
        (2, 0, 1) => "The Dragonbinder's second entry:\n\"The ruins don't give the pieces\nup easily. Perhaps they are\ntesting the one who gathers.\"",
        (2, 2, 1) => "A worn soldier's badge:\nAshenfall garrison, third\nregiment. The name has been\nworn away by careful thumbs.",
        (3, 4, 2) => "The Dragonbinder's third entry:\n\"The vault was built around the\npiece -- not to display it.\nTo bury it.\"",
        (3, 2, 1) => "A child's drawing scratched in\nstone: a dragon and 8 circles.\nBelow it, a name:\n\"Mira, age 6.\"",
        (4, 1, 1) => "The Dragonbinder's fourth entry:\n\"Perhaps 'sealed' is the wrong\nword. Perhaps it was\n'enshrined.'\"",
        (4, 3, 1) => "A sea captain's log: \"We brought\nthe piece up from the lake floor.\nThe water followed it.\nI think we made a mistake.\"",
        (4, 3, 2) => "The Citadel's last census:\n\"Current garrison: 1. I am the\nlast guard of something very\nimportant. I will do my job.\"",
        (5, 0, 0) => "The Forgemaster's study. On the\nwall, a child's drawing -- wings\nspread wide. Signed:\n\"Mira, age 7.\"",
        (5, 4, 0) => "The Forgemaster's note: \"I built\nthis vault to hold one name --\nthe one who came before us all:\nThe Dragonbinder.\"",
        (5, 3, 3) => "Casting record #847: \"The piece\ndoes not want to be contained.\nIt wants to be part of\nsomething.\"",
        (6, _, _) => "A letter, unsent: \"The pieces\nwant to be together. Think very\ncarefully before you place the\nlast one. -- M.\"",
        (7, _, _) => "Mira's drawing, age 9. The\ndragon is whole and luminous.\nBeneath it: \"I think it's\nlonely.\"",
        (8, 1, 1) => "The dais inscription: \"You have\nseen what I was. What remains\nis yours to decide. I can be\npatient a little longer.\"",
        (8, 4, 3) => "The Dragon's Own Words: \"The\nchoice you are about to make\nis real. Take your time. A few\nmoments will not hurt either of us.\"",
        (8, 0, 0) => "Two carved symbols, side by\nside: a broken chain, and an\nunbroken ring. Neither glows\nbrighter than the other.",
        (8, 0, 1) => "The Final Dragonbinder Letter:\n\"I could not place the last\npiece. I left it for you.\nDecide honestly. -- M.\"",
        (8, 3, 1) => "Mira's final drawing, age 11.\nThe dragon free, above a world\nat peace. \"I hope you ask it\nwhat it wants. -- Mira.\"",
        (8, 3, 0) => "The Dragon's Own Letter:\n\"Whatever you decide is the\nright decision. I have been\ntrusting you since Mosshaven.\"",
        (8, _, _) => "The dragon's own hand: \"I sent\nthe pieces away so whoever\ngathered them would be worthy\nof the choice. You chose.\"",
        _ => "An old journal page, the ink\nfaded past reading.",
    }
}
...
const LEVEL2_ROOMS: &[DungeonRoomDef] = &[
    ...
    DungeonRoomDef {
        ...
        items: &[
            ScreenItemDef {
                pickup_type: PickupType::GemLarge,
                tile_x: 7,
                tile_y: 8,
            },
            ScreenItemDef {
            ...
            // Iron Dart — a previous explorer's stash (spec: hidden chest, throwing t1).
            ScreenItemDef {
                pickup_type: PickupType::WeaponThrowing(1),
                tile_x: 5,
                tile_y: 5,
            },
            // Mosshaven Vest (body t2) — oilskin-wrapped, still dry.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Body, 2),
                tile_x: 10,
                tile_y: 5,
            },
            ScreenItemDef {
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The Dragonbinder's Second Entry.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 2,
            },
            // Ashbrand — the Warden's blade, kept here in the reliquary (sword t2).
            ScreenItemDef {
                pickup_type: PickupType::WeaponSword(2),
                tile_x: 5,
                tile_y: 3,
            },
            // Carved Boomerang — a traveller's offering (boomerang t1).
            ScreenItemDef {
                pickup_type: PickupType::WeaponBoomerang(1),
                tile_x: 11,
                tile_y: 3,
            },
            ScreenItemDef {
...
const LEVEL3_ROOMS: &[DungeonRoomDef] = &[
    ...
    DungeonRoomDef {
        ...
        room_clear_rewards: &[
            ...
            // Ironwing — the Vault's restraint tool, freed by the gear-lock (boomerang t2).
            ScreenItemDef {
                pickup_type: PickupType::WeaponBoomerang(2),
                tile_x: 7,
                tile_y: 6,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The Dragonbinder's Third Entry.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 2,
            ...
            // Vault Plate (body t4) — factory-grade, pressure-sealed for centuries.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Body, 4),
                tile_x: 12,
                tile_y: 6,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // Mira's drawing, age 6 — a dragon and eight circles.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 2,
            },
            // Ironclad Visor (head t4).
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Head, 4),
                tile_x: 12,
                tile_y: 5,
            },
            ScreenItemDef {
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // Splitblade — the Vault's anti-swarm tool (throwing t2).
            ScreenItemDef {
                pickup_type: PickupType::WeaponThrowing(2),
                tile_x: 3,
                tile_y: 5,
            },
            // Ironclad Legplates (legs t4).
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Legs, 4),
                tile_x: 12,
                tile_y: 5,
            },
            ScreenItemDef {
...
const LEVEL4_ROOMS: &[DungeonRoomDef] = &[
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // Tidecoat (body t5) — sealed against flood, fire, and failure.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Body, 5),
                tile_x: 12,
                tile_y: 7,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The Citadel's Last Census, wedged above the waterline.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 10,
                tile_y: 7,
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The Dragonbinder's Fourth Entry — "enshrined, not sealed."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 2,
            },
            // Tidestride Boots (legs t5) — they never fill with water.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Legs, 5),
                tile_x: 5,
                tile_y: 4,
            },
            ScreenItemDef {
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The Sea Captain's Log — "the water followed it."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 6,
...
const LEVEL5_ROOMS: &[DungeonRoomDef] = &[
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            ScreenItemDef {
                pickup_type: PickupType::GemSmall,
                tile_x: 2,
                tile_y: 8,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // Mira's drawing, age 7 — wings spread wide.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 11,
                tile_y: 3,
            },
            // Forgeplate (body t6) — still radiating warmth.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Body, 6),
                tile_x: 4,
                tile_y: 3,
            },
            ScreenItemDef {
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // The Forgemaster's note about the Dragonbinder.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 3,
            },
            // Forge Crown (head t6) — the iron circlet, still warm.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Head, 6),
                tile_x: 11,
                tile_y: 3,
            },
            ScreenItemDef {
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // Casting record #847 — "it wants to be part of something."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 10,
                tile_y: 3,
...
const LEVEL6_ROOMS: &[DungeonRoomDef] = &[
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // Void Mantle (body t7) — Duplexis's shed skin, solid and translucent by turns.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Body, 7),
                tile_x: 12,
                tile_y: 5,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The Dragonbinder's Sixth Entry, beside the candle.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 4,
            ...
            // Void Veil (head t7) — thin hood of void-silk.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Head, 7),
                tile_x: 11,
                tile_y: 6,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // Voidlance — the blade that exists between states (throwing t3).
            ScreenItemDef {
                pickup_type: PickupType::WeaponThrowing(3),
                tile_x: 10,
                tile_y: 6,
            },
            // Void Steps (legs t7) — footsteps make no sound.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Legs, 7),
                tile_x: 12,
                tile_y: 3,
            },
        ],
...
const LEVEL7_ROOMS: &[DungeonRoomDef] = &[
    ...
    DungeonRoomDef {
        ...
        room_clear_rewards: &[
            ...
            // The Starforged Blade, from the empty weapon rack at the Apex (sword t3).
            ScreenItemDef {
                pickup_type: PickupType::WeaponSword(3),
                tile_x: 8,
                tile_y: 8,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // Star Helm (head t8) — a single star-crystal at the brow.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Head, 8),
                tile_x: 6,
                tile_y: 5,
            },
            ScreenItemDef {
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // The Celestial Ring — sold to Mira, left behind, waiting (boomerang t3).
            ScreenItemDef {
                pickup_type: PickupType::WeaponBoomerang(3),
                tile_x: 3,
                tile_y: 7,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        items: &[
            // The Dragonbinder's Seventh Entry — written upside-down.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 4,
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // Mira's drawing, age 9 — "I think it's lonely."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 6,
                tile_y: 7,
...
const LEVEL8_ROOMS: &[DungeonRoomDef] = &[
    ...
    DungeonRoomDef {
        ...
        items: &[
            // The dais inscription — "What remains is yours to decide."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 7,
                tile_y: 5,
    ...
    DungeonRoomDef {
        ...
        items: &[
            // Star Greaves (legs t8) — the mural plate puzzle's reward.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Legs, 8),
                tile_x: 8,
                tile_y: 6,
            },
        ],
    ...
    DungeonRoomDef {
        ...
        items: &[
            // The Dragon's Own Words — "the choice you are about to make is real."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 7,
                tile_y: 4,
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The broken chain and the unbroken ring.
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 3,
    ...
    DungeonRoomDef {
        ...
        items: &[
            ...
            // The Final Dragonbinder Letter — "For the one who comes after me."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 8,
                tile_y: 8,
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // Mira's final drawing, age 11 — "I hope you ask it what it wants."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 4,
                tile_y: 3,
    ...
    DungeonRoomDef {
        ...
        enemies: &[],
        items: &[
            // The Dragon's Own Letter — "I have been trusting you since Mosshaven Cave."
            ScreenItemDef {
                pickup_type: PickupType::Lore,
                tile_x: 5,
                tile_y: 3,
            },
            // Constellation Plate (body t8) — seven star-crystals set into the chest.
            ScreenItemDef {
                pickup_type: PickupType::Armor(ArmorSlot::Body, 8),
                tile_x: 8,
                tile_y: 6,
            },
            ScreenItemDef {
...
fn overworld_screen_items(screen_x: i32, screen_y: i32) -> Vec<ItemDef> {
    match (screen_x, screen_y) {
        ...
        // Hollow Root Clearing — Codex page 1 + Mira's first drawing (age 5).
        (4, 10) => vec![
            item(PickupType::Gem, 8, 5),
            item(PickupType::CodexPage, 7, 4),
            item(PickupType::Lore, 9, 4),
        ],
        (4, 12) => vec![item(PickupType::Gem, 7, 5), item(PickupType::Gem, 9, 5)],
        // Deep Ash Pit — Codex page 2 + the burned journal page.
        (6, 11) => vec![
            item(PickupType::Gem, 8, 5),
            item(PickupType::CodexPage, 8, 4),
            item(PickupType::Lore, 7, 6),
        ],
        // Great Aqueduct — Codex page 3 + the engineer's final report.
        (1, 6) => vec![
            item(PickupType::Gem, 7, 5),
            item(PickupType::Gem, 9, 5),
            item(PickupType::CodexPage, 8, 4),
            item(PickupType::Lore, 8, 6),
        ],
        // Hidden Sea Cave — Codex page 4 + Mira's sea drawing (age 6).
        (12, 6) => vec![
            item(PickupType::Gem, 8, 5),
            item(PickupType::CodexPage, 7, 4),
            item(PickupType::Lore, 9, 4),
        ],
        // Basalt Cache — Codex page 5 + the forge workers' cache note.
        (8, 7) => vec![
            item(PickupType::CodexPage, 8, 4),
            item(PickupType::Lore, 8, 6),
        ],
        (7, 6) => vec![item(PickupType::Gem, 8, 5)],
        // Mirror Pool — Codex page 6 + M's note about the throne room.
        (6, 5) => vec![
            item(PickupType::Gem, 8, 5),
            item(PickupType::CodexPage, 7, 4),
            item(PickupType::Lore, 9, 4),
        ],
        // Star Map Plaza — Codex page 7 + the builder's note.
        (9, 2) => vec![
            item(PickupType::Gem, 7, 5),
            item(PickupType::Gem, 9, 5),
            item(PickupType::CodexPage, 8, 4),
        ...
        // Threshold Stone — Mira's carved names, five visits across a lifetime.
        (4, 1) => vec![item(PickupType::Gem, 8, 5), item(PickupType::Lore, 8, 6)],
        _ => vec![],
    }
}
